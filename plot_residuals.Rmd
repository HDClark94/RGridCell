...
```{r}
simulationOutput <- simulateResiduals(fittedModel = beaconed_model_full, n=10000)
...
plotResiduals(simulationOutput, form = beaconed_data$rolling_classifier, quantreg = FALSE)

# if pred is a factor, or if asFactor = T, will produce a boxplot
plotResiduals(simulationOutput, form = beaconed_data$mouse_id)

# All these options can also be provided to the main plotting function

# If you want to plot summaries per group, use
simulationOutput = recalculateResiduals(simulationOutput, group = beaconed_data$mouse_id)
plot(simulationOutput, quantreg = FALSE) 
